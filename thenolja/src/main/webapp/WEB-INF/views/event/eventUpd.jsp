					...
					<div class="array-list" data-attr_item_vlue="null">
						...
						<div class="item">
							<div class="select-box bg-gray" style="float:left; margin-right:10px;">
								<!-- 이벤트 시작일 세팅 -->
								<c:if test="${not empty event.EventStrtDt}">
									<input type="date" id="eventStrt" class="evnt_inner_inpt" name="eventStrtDt" value="${event.EventStrtDt()}">
								</c:if>
							</div>
						</div>
						...
						<div class="item">
							<div class="select-box bg-gray" style="float:left; margin-right:10px;">
								<!-- 이벤트 종료일 세팅 -->
								<c:if test="${event.EventEndDt}">
								<input type="date" id="eventEnd" class="evnt_inner_inpt" name="eventEndDt" value="${event.EventEndDt()}">
								</c:if>
							</div>
						</div>
